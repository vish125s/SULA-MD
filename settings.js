...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝐒𝐔𝐋𝐀-𝐌𝐃=h3UwHTJK#NNLm4ATWwLR5ZvT5wNsVux8ILrA2ps3XZGB4-2-HYQc' : process.env.SESSION_ID,
...
AI_REPLAY: process.env.AI_REPLAY === undefined ? "true" : process.env.AI_REPLAY,// Hey
